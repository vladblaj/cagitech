      ...
      <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
        ...
        <CollapsibleContent className="px-6 pb-6">
           ...
           <div className={cn(
             ...
             <div
               className={cn(
                 "bg-timberwolf/20 dark:bg-jet/20 rounded-xl p-8 flex flex-col items-center max-h-[calc(100vh-12rem)] overflow-y-auto",
                      ...
                      <div className="flex flex-col items-center">
                        <div className="relative w-1 h-12 bg-timberwolf dark:bg-jet rounded-full overflow-hidden">
                          <div
                            className={cn(
                              ...
                              isCompleted ? "bg-jonquil" : "bg-timberwolf dark:bg-jet"
                            )}
                          />
                          {isExecuting && (
                        ...
                        <div
                          className={cn(
                            ...
                            isCompleted ? "border-t-jonquil" : "border-t-timberwolf dark:border-t-jet"
                          )}
                        />
                      </div>
                    )}
